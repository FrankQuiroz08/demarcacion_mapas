...
var format_Indices_14 = new ol.format.GeoJSON();
var features_Indices_14 = format_Indices_14.readFeatures(json_Indices_14, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_Indices_14 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Indices_14.addFeatures(features_Indices_14);
var lyr_Indices_14 = new ol.layer.Vector({
                declutter: true,
                source:jsonSource_Indices_14, 
                style: style_Indices_14,
                interactive: true,
                title: '<img src="styles/legend/Indices_14.png" /> Indices'
            });
var format_MARCADORLIMA_15 = new ol.format.GeoJSON();
var features_MARCADORLIMA_15 = format_MARCADORLIMA_15.readFeatures(json_MARCADORLIMA_15, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_MARCADORLIMA_15 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_MARCADORLIMA_15.addFeatures(features_MARCADORLIMA_15);
var lyr_MARCADORLIMA_15 = new ol.layer.Vector({
                declutter: true,
                source:jsonSource_MARCADORLIMA_15, 
                style: style_MARCADORLIMA_15,
                interactive: true,
                title: '<img src="styles/legend/MARCADORLIMA_15.png" /> MARCADOR LIMA'
            });
var format_CENTROSCEREMONIALES_16 = new ol.format.GeoJSON();
var features_CENTROSCEREMONIALES_16 = format_CENTROSCEREMONIALES_16.readFeatures(json_CENTROSCEREMONIALES_16, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_CENTROSCEREMONIALES_16 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_CENTROSCEREMONIALES_16.addFeatures(features_CENTROSCEREMONIALES_16);
var lyr_CENTROSCEREMONIALES_16 = new ol.layer.Vector({
                declutter: true,
                source:jsonSource_CENTROSCEREMONIALES_16, 
                style: style_CENTROSCEREMONIALES_16,
                interactive: true,
                title: '<img src="styles/legend/CENTROSCEREMONIALES_16.png" /> CENTROS CEREMONIALES'
            });
...
var group_CULTURALIMA = new ol.layer.Group({
                                layers: [lyr_Indices_14,lyr_MARCADORLIMA_15,lyr_CENTROSCEREMONIALES_16,],
                                title: "CULTURA LIMA"});
...
lyr_Indices_14.set('fieldAliases', {});
lyr_MARCADORLIMA_15.set('fieldAliases', {'MARCADOR': 'MARCADOR', });
lyr_CENTROSCEREMONIALES_16.set('fieldAliases', {'cen_cere': 'cen_cere', });
...
lyr_Indices_14.set('fieldImages', {});
lyr_MARCADORLIMA_15.set('fieldImages', {'MARCADOR': 'TextEdit', });
lyr_CENTROSCEREMONIALES_16.set('fieldImages', {'cen_cere': 'TextEdit', });
...
lyr_Indices_14.set('fieldLabels', {});
lyr_MARCADORLIMA_15.set('fieldLabels', {});
lyr_CENTROSCEREMONIALES_16.set('fieldLabels', {});
